...
*All items are written as independent, testable tasks for your AI developer.  Work straight down every phase; within each feature, sub-items have **zero internal dependencies**.*
...
[ ] **Feature 2 – Core Data Structures & Security**  
  - [ ] **2.1** Define an SQLite schema for *personas, evidence, product docs, scores*.  
...
## Phase 2 – **Data Layer**  
*Criteria: storage & computation services, depends only on Phase 1.*
...
## Phase 3 – **Interface Layer**  
*Criteria: user-facing components; each relies on Phases 1 & 2.*
...
## Phase 4 – **Implementation Layer**  
*Criteria: value-delivering capabilities built atop 1–3.*
...
[ ] **Feature 4 – Proactive Notifications & Retro Tools**  
  ...
  - [ ] **4.4** Build a *Retro Wizard* that imports a failed feature (CSV or Jira) and quantifies wasted effort.  
