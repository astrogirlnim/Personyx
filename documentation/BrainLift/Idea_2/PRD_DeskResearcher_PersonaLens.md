...
_Desktop AI companion that ingests real customer-interview transcripts, clusters insights by **persona**, scores every PRD for evidence, and lets devs/PMs chat with persona bots—^before^ and ^during^ coding._
...
_(Starter YAML file can be expanded later.)_
...
_Embeddings: OpenAI `text-embedding-3-small` (fallback to local MiniLM)._
...
1. Should Evidence Score weight _sentiment_ or just _volume + recency_?
...
_Prepared 30 June 2025 for FlowGenius desktop-AI sprint._
