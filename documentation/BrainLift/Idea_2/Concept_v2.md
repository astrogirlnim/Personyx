...
| **AI Workflow** | LangGraph chain → cluster by *feature* + *severity*; store results locally (SQLite + AES-256) |
...
*Use this concept as your “north star” BrainLift doc and checkpoint progress against the Phase tables above.*  
