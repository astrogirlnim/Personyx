            ...
            >
              <div className="flex items-start justify-between">
                <div className="flex-1">
                  ...
                  <p className="text-body-sm text-steel dark:text-steel-dark mt-2">
                    {persona.description}
                  </p>
                  <div className="mt-3 space-y-2">
                    <div>
                      <span className="text-caption font-medium text-slate dark:text-slate-dark">
                        Primary Goal:
                      </span>
                      ...
                      <div className="flex flex-wrap gap-1 mt-1">
                        {persona.keywords?.map(
                          (keyword: string, index: number) => (
                            <span
                              key={index}
                              className="px-2 py-1 text-caption bg-persona/10 dark:bg-persona-dark/10 text-persona dark:text-persona-dark rounded"
                            >
                              {keyword}
                            </span>
                          )
